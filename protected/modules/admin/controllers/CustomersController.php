...
class CustomersController extends Controller
{
   ...
   public function gridPlatform($data,$row){
      $id = $data->platform_id;
      if($id){
         $detail = Platforms::model()->findByPk($id);
         return $detail->platform_name;   
      }else{
         return '-- Chưa chọn --';
      }
   ...
   public function gridPackage($data,$row){
      $id = $data->package_id;
      if($id){
         $detail = Packages::model()->findByPk($id);

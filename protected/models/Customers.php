...
class Customers extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('device_token, udid, platform_id, create_date, name, email', 'required'),
			array('platform_id, status, package_id', 'numerical', 'integerOnly'=>true),
			...
			array('id, device_token, udid, platform_id, create_date, expire_date, name, email, status, package_id', 'safe', 'on'=>'search'),
		);
	}
